...
namespace Backend.Migrations
{
    ...
    [Migration("20251129195407_ExtendingDocumentPositionUnitPriceTypes")]
    partial class ExtendingDocumentPositionUnitPriceTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Entities.DocumentPosition", b =>
                {
                    ...
                    b.Property<int>("DocumentPositionTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DocumentPositionTypeId");

                    b.ToTable("DocumentPositions");
                });

            modelBuilder.Entity("Backend.Entities.DocumentPositionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DocumentPositionTypes");
                });
            ...
            modelBuilder.Entity("Backend.Entities.DocumentPosition", b =>
                {
                    ...
                    b.HasOne("Backend.Entities.DocumentPositionType", "DocumentPositionType")
                        .WithMany()
                        .HasForeignKey("DocumentPositionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdmissionDocument");

                    b.Navigation("DocumentPositionType");
                });
